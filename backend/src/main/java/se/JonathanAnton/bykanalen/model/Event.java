...
public class Event {
    ...
    public Event(String title, byte[] image, String description, LocalDateTime publishDate, LocalDateTime startDate, LocalDateTime endDate, LocalDateTime closeRegistrationDate) {
        this.title = title;
        this.image = image;
