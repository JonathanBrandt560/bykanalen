...
public class EventService {
    ...
    public EventService(EventRepository eventRepository, EventRegistrationRepository eventRegistrationRepository, EventMapper eventMapper, GroupRepository groupRepository, AuthorizationService authorizationService) {
